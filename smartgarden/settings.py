...
# Email
# Use the console backend by default so development does not attempt to send
# real mail. Production deployments should set EMAIL_BACKEND and the SMTP
# variables below explicitly.
